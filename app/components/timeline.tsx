...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div className="w-full bg-neutral-950 text-white font-sans md:px-10" ref={containerRef}>
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                <h3 className="hidden md:block text-xl 0 md:text-5xl font-bold text-white ">
My two big passions              </h3>
                <p className="text-white text-sm md:text-base max-w-sm">
                   <br/> Here are some of my most significant experiences and contributions in the field of youth advocacy, technology, and innovation.
                </p>
            </div>
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-neutral-900 flex items-center justify-center">
                                <div className="h-4 w-4 rounded-full bg-neutral-700 border border-neutral-800 p-2" />
                            </div>
